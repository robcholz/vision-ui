...
#ifdef CONFIG_VISION_UI_ICON_VIEW_DESCRIPTION_AREA_HEIGHT
#define VISION_UI_ICON_VIEW_DESCRIPTION_AREA_HEIGHT CONFIG_VISION_UI_ICON_VIEW_DESCRIPTION_AREA_HEIGHT
#else
#define VISION_UI_ICON_VIEW_DESCRIPTION_AREA_HEIGHT 35 // the height of the description area
#endif
