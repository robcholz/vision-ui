...
#include "vision/vision_ui_drawer.h"
...
enum ui_action_t vision_ui_get_ui_action(void) {
    switch (get_key()) {
        case SDLK_UP:
...
void oled_draw_bMP(uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint8_t* bit_map) {
